...
vcf_file_address =  "/Volumes/uni/myjupyter/jupyter_phaseme/ont_son/1/1_ont_true.vcf" # son_improved_.90_tr1
...
for block_id_sample1, list_all_block in list_all_blocks.items(): 
    ...
    for block_id_sample2, list1 in list_all_block.items(): 
        ...
        # if block_id_sample1 =='20610824': print(list1)
...
# vcf_file_address = type_data+'_son/'+str(chrom)+'_'+type_data+'_son.vcf'  # truth
...
for block_id_sample1, length_minor_block in length_minor_blocks.items(): 
    ...
    for block_id_sample2, length_minor in length_minor_block.items(): 
        ...
        lower_than_21_logic=[length1<11 for length1 in list_length_minor]
