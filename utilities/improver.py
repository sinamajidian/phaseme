...
def decide_cut1(id_blocks, allele_blocks, var_pos_blocks, comparison_result_blocks):
...
if __name__ == "__main__":
    ...
    Input: vcf, pair, vcf_comparison.txt            # the last file is the output of the qc.py

    Output: vcf_improved

    """

    vcf_file_address =  argv[1]  # "22_ont.vcf"
    ...
    file_pairs_address= argv[2]  # "22_ont_pairs_500_0.9.txt" # 
    
    pop_inf_dic = read_file_pairs_forward(file_pairs_address)         


    file_mismatches_address = vcf_file_address[:-4]+'_comparison.txt'
