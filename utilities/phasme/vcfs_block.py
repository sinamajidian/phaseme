...
#                 exit(1)
    ...
    for var_pos_block in var_pos_blocks:
        ...
        hap_length.append(len(var_pos_block))        




    return genomic_length_blocks,id_blocks,hap_length
...
#        print(vcf_file_address)
        genomic_length_blocks,id_blocks,hap_length = read_vcf_file_with_truth(vcf_file_address)
        #block_all= block_all+genomic_length_blocks
        

        #print(len(genomic_length_blocks))
        print(np.mean(hap_length) ) # id_blocks
