...
if __name__ == "__main__":
    ...
    vcf_file_address = type_data+'_son/'+str(chrom)+'/'+str(chrom)+'_'+type_data+'_true.vcf'
    ...
    file_mismatches_address = type_data+'_son/'+str(chrom)+'_report_mismatches_'+Forward_or_both+'.txt'
    ...
    vcf_file_improved_address = type_data+'_son/'+str(chrom)+'_'+type_data+'_son_improved_.90_tr1.vcf' 
